...
@Component({
  selector: 'contact-us-flyer-horizontal',
  templateUrl: './contact-us-flyer-horizontal.component.html',
  styleUrls: ['./contact-us-flyer-horizontal.component.css']
})
export class ContactUsFlyerHorizontalComponent {

...
@Component({
  selector: 'compare-products-search-list',
  templateUrl: './compare-products-search-list.component.html',
  styleUrls: ['./compare-products-search-list.component.css']
})
export class CompareProductsSearchListComponent {
  ...
  public selectedItem(item){
    this.selectedProductItem.emit(item);
  }
